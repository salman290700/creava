...
func (r *creatorTransactionRepository) GetCreatorTransaction(ctx context.Context, id int64) (*model.CreatorTransaction, error) {
	query := `SELECT * FROM creator_transaction WHERE id = ?`
